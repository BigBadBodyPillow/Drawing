export default function Shark() {
  return (
    <div className="relative flex items-center justify-center gap0">
      <div
        className="head w-13 h-7 bg-cyan-600 "
        style={{
          clipPath:
      ...
      <div
        ...
        style={{
          clipPath:
            "shape(from 0 0, curve to 100% 40% with 60% 0, vline to 75%, curve to 0 100% with 40% 100% ",
        }}
      ></div>
      <div
      ...
      ></div>
      <div
        className="top-small-back-fin w-2 h-1.5 bg-cyan-600 absolute top-4.25 right-9 "
        style={{
          clipPath:
      ...
      ></div>
      <div
        className="small-side-back-fin w-3 h-4 bg-cyan-600 absolute top-8 right-9 rotate-156 scale-x-[-1]"
        style={{
          clipPath:
            "shape(from 0 100%, curve to 100% 0 with 20% 20%, curve to 100% 100% with 80% 50%)",
        }}
      ...
      <div
        ...
        style={{
          clipPath:
            "shape(from 0 45%,curve to 100% 5% with 40% 20%, curve to 40% 60% with 60% 45%, line to 66% 90%, line to 0 65%)",
